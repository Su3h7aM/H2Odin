...
- [`specs/`](specs/) — numbered design specs for major decisions (bit-field emission, self-hosted libclang, multi-file emission, bit_set backing width, opaque handles, imports_file removal).
