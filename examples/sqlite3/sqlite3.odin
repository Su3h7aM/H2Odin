...
sqlite3_io_methods :: struct {
	...
	xRead: proc "c" (_: ^sqlite3_file, _: rawptr, _: i32, _: sqlite3_int64) -> i32,
	xWrite: proc "c" (_: ^sqlite3_file, _: rawptr, _: i32, _: sqlite3_int64) -> i32,
	xTruncate: proc "c" (_: ^sqlite3_file, _: sqlite3_int64) -> i32,
	xSync: proc "c" (_: ^sqlite3_file, _: i32) -> i32,
	xFileSize: proc "c" (_: ^sqlite3_file, _: ^sqlite3_int64) -> i32,
	...
	xFetch: proc "c" (_: ^sqlite3_file, _: sqlite3_int64, _: i32, _: ^rawptr) -> i32,
	xUnfetch: proc "c" (_: ^sqlite3_file, _: sqlite3_int64, _: rawptr) -> i32,
}
...
sqlite3_vfs :: struct {
	...
	/*
	  ...
	  */
	xCurrentTimeInt64: proc "c" (_: ^sqlite3_vfs, _: ^sqlite3_int64) -> i32,
	/*
...
sqlite3_module :: struct {
	...
	xRowid: proc "c" (_: ^sqlite3_vtab_cursor, _: ^sqlite3_int64) -> i32,
	xUpdate: proc "c" (_: ^sqlite3_vtab, _: i32, _: ^^sqlite3_value, _: ^sqlite3_int64) -> i32,
...
Fts5ExtensionApi :: struct {
	...
	xRowCount: proc "c" (_: ^Fts5Context, _: ^sqlite3_int64) -> i32,
	xColumnTotalSize: proc "c" (_: ^Fts5Context, _: i32, _: ^sqlite3_int64) -> i32,
	...
	xRowid: proc "c" (_: ^Fts5Context) -> sqlite3_int64,
