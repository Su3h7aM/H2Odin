...
when ODIN_OS == .Windows {
	...
	foreign import lib {"system:ntdll.lib", "system:ucrt.lib", "system:msvcrt.lib", "system:legacy_stdio_definitions.lib", "system:kernel32.lib", "system:user32.lib", "system:advapi32.lib", "system:shell32.lib", "system:ole32.lib", "system:oleaut32.lib", "system:uuid.lib", "system:ws2_32.lib", "system:version.lib", "system:oldnames.lib", "libclang.lib"}
} else {
...
*/
Inclusion_Visitor :: proc "c" (_: File, _: ^Source_Location, _: c.uint, _: Client_Data)
...
Indexer_Callbacks :: struct {
	...
	*/
	abortQuery:             proc "c" (_: Client_Data, _: rawptr) -> c.int,

	/**
	* Called at the end of indexing; passes the complete diagnostic set.
	*/
	diagnostic:             proc "c" (_: Client_Data, _: Diagnostic_Set, _: rawptr),
	enteredMainFile:        proc "c" (_: Client_Data, _: File, _: rawptr) -> Idx_Client_File,

	/**
	* Called when a file gets \#included/\#imported.
	*/
	ppIncludedFile:         proc "c" (_: Client_Data, _: ^Idx_Included_File_Info) -> Idx_Client_File,
	...
	* the AST file.
	*/
	importedASTFile:        proc "c" (_: Client_Data, _: ^Idx_Imported_Astfile_Info) -> Idx_Client_Astfile,

	/**
	* Called at the beginning of indexing a translation unit.
	*/
	startedTranslationUnit: proc "c" (_: Client_Data, _: rawptr) -> Idx_Client_Container,
	indexDeclaration:       proc "c" (_: Client_Data, _: ^Idx_Decl_Info),

	/**
	* Called to index a reference of an entity.
	*/
	indexEntityReference:   proc "c" (_: Client_Data, _: ^Idx_Entity_Ref_Info),
}
...
foreign lib {
	...
	*/
	...
	executeOnThread :: proc(fn: proc "c" (_: rawptr), user_data: rawptr, stack_size: c.uint) ---
